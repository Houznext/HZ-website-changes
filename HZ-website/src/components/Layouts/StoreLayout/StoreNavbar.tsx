          ...
          <div className="store-nav-profile" ref={profileRef} style={{ position: 'relative' }}>
            ...
            {profileOpen && isLoggedIn && (
              <div style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, background: '#fff', border: '1px solid #dde8f5', borderRadius: 12, width: 220, zIndex: 500 }}>
                {[{ label: 'My account', href: '/my-account' }, { label: 'My orders', href: '/my-account?tab=orders' }, { label: 'Wishlist', href: '/store/wishlist' }, { label: 'Saved designs', href: '/my-account/saved-designs' }, { label: 'LiveBuild project', href: '/livebuild/dashboard' }].map((item) => (
