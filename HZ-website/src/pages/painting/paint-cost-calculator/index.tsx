...
const PaintCostEstimator = () => {
  return (
    <div>
      <SEO
        title="Painting Services | Expert Home & Commercial Painting | Houznext"
        ...
        keywords="Painting Services, Home Painting, Commercial Painting, Interior Painting, Exterior Painting, Wall Painting, House Painting, Professional Painters, Houznext Painting"
/>
