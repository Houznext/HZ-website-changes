...
export default function NewPropertyStep5() {
  ...
  return (
    <AdminLayout
      ...
      header={
        <ListingWizardHeader
          backHref="/new-property/insights"
    ...
    >
      ...
      <div style={{ marginTop: 18, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
        <button type="button" className="btn btn-ghost btn-sm" onClick={() => void router.push('/new-property/insights')}>
          ← Back
        </button>
